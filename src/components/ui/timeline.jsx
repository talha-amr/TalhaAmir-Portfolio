        ...
        >
            ...
            <div ref={ref} className="relative max-w-7xl md:max-w-[88vw] mx-auto pb-20 md:pb-[13.88vw]">
                ...
                <div
                    ...
                    className="absolute md:left-[2.22vw] left-8 top-0 overflow-hidden w-[2px] md:w-[0.14vw] bg-[linear-gradient(to_bottom,var(--tw-gradient-stops))] from-transparent from-[0%] via-neutral-700 to-transparent to-[99%]  [mask-image:linear-gradient(to_bottom,transparent_0%,black_10%,black_90%,transparent_100%)] "
                >
                    <motion.div
                        style={{
                        ...
                        className="absolute inset-x-0 top-0  w-[2px] md:w-[0.14vw] bg-gradient-to-t from-purple-500 via-blue-500 to-transparent from-[0%] via-[10%] rounded-full"
                    />
                </div>
            </div>
        </div>
