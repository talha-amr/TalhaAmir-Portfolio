...
export function Header() {
    ...
    return (
        <header
            className={cn(
                'fixed top-0 left-0 right-0 z-50 mx-auto max-w-[94vw] border-b border-transparent transition-all duration-300 ease-out',
                {
        ...
        >
            <div className={cn("w-full transition-all duration-300", scrolled && !open ? "px-6 md:px-[1.66vw]" : "my-container")}>
                <nav
                    className={cn(
                        'flex h-20 md:h-[5.55vw] w-full items-center justify-between transition-all ease-out',
                        {
            ...
            <div
                className={cn(
                    'fixed top-[80px] right-0 bottom-0 left-0 z-50 flex flex-col overflow-hidden bg-[#0b0b0d] md:hidden',
                    open ? 'block' : 'hidden',
                )}
            >
                <div
                ...
                >
                        ...
                        {links.map((link) => (
                            <a
                                ...
                                className={buttonVariants({
                                    variant: 'ghost',
                                    className: 'justify-start text-lg font-medium text-[#f5f5f7] hover:text-white hover:bg-white/10 h-12',
                                })}
                                href={link.href}
                    ...
                    <div className="flex flex-col gap-2">
                        <a
                            href="#contact"
                            className={cn(buttonVariants({ variant: 'default' }), "w-full bg-[#f5f5f7] text-black hover:bg-white h-12 text-base font-semibold rounded-xl")}
                            onClick={() => setOpen(false)}
                        >
                            Lets Talk
                        </a>
